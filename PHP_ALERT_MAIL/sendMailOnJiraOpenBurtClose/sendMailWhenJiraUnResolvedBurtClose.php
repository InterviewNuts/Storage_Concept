...
include_once  (PROJECT_PATH . '/htmlReportTable/burtCloseJiraOpen.php');
...
$text = file_get_contents('./htmlReportTable/burtCloseJiraOpen.html');
...
if(!empty($text))
{
    ...
    $cont.="It is a gentle reminder to close it. If Jira Case is closed, then please ignore the mail";
