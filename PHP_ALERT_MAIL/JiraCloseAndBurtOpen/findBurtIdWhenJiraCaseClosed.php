...
//! all the burts will be written in this path and file. This will be read by closeBurtIdWhenJiraCaseClosed.py from inside VED.
$myfile = fopen("/x/eng/sustools/MFT/CPE_SolidFire_Sync/froyo_solidfire_burtlist.txt", "w") or die("Unable to open file burtCloseFile.txt!\n");
